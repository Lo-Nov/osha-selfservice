...
class ParkingPenaltiesController extends Controller
{
    ...
    public function parkingPenalties()
    {
        ...
        $data = [
            'zones' => $parking_info->zones,
            'durations' => $parking_info->durations,
            'vehicle_categories' => $parking_info->vehicle_categories,
        ];
    ...
    {
    	$url = config('global.url'). 'Parking/GetPenaltyCharge';
    ...
    {   
        $url = $this->url. 'Parking/InitiateParkingPayment';

        $data = [
            'vehicle_category_code' =>$request->vehicle_category_code,
            'zone_code' => $request->zone_code,
            'duration_code' => $request->duration_code,
