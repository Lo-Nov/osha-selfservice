...
class SeasonalController extends Controller
{
    ...
    public function index()
    {
	        ...
	        $data = [
	        	...
	        	'vehicles' => $vehicles->response_data,
            ];
            
            // dd($data);  


        	return view('seasonal.index', $data);
    ...
    public function addVehicle(Request $request)
    {
    	...
    	$data = [
    		'number_plate' => $request->registration_no,
    		'category_id' => $request->vehicle_description,
    ...
    public function removeEntry(Request $request)
    {
        ...
        $url = $this->url .'Parking/RemoveParkingEntry?entryId='. $request->parking_code;
        ...
        return response()->json($removedVehicle);
    }
    ...
    public function initiatePayment(Request $request)
    {
        ...
        $url = $this->url . 'Parking/InitiateParkingPayments';
