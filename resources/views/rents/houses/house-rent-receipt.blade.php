    ...
    <div class="main row">
      <div class="topBar col-12">
        ...
        <div class="row align-items-center">
          <div class="col-7">
            <h1 class="receipt">House Rent Receipt</h1>
          </div>
        ...
        <div class="row">
          ...
          <div class="sec1Right pr-50px col-7">
            <div class="receiptNo">
              ...
              <p class="secPContent" id="receipt">{{receiptNo}}</p>
              <div class="barImg">
      ...
      <div class="interSecDet container">
        <div class="interSecDetContent row">
          <p class="descriptionDet pl-50px col-5">
			  {{description}}
			  <br>
			  <span class="font12">Daily parking for KBH 567T at Moi avenue</span>
			</p>
          <p class="timeDet col-3 text-center">{{time}}</p>
          <p class="totalDet col-4 text-right pr-50px"  id="ksh">{{total}}</p>
        </div>
      </div>
      ...
      <div class="slantMain container">
        <div class="row align-items-start">
          ...
          <div class="col-4 px-0">
            <p class="kshHead text-right pr-50px">{{total}}</p>
            <p class="kshHead text-right pr-50px">{{total}}</p>
            <p class="kshHead text-right pr-50px">{{total}}</p>
          </div>
        </div>
      ...
      <footer>
        <div class="bill container">
          <div class="row">
            <div class="col-6">
              <p>Served by: Peter Griffin</p>
            </div>
            <div class="col-6">
              <p class="text-right">Bill No: <span class="billNo">123456789</span></p>
            </div>
          </div>
        </div>
