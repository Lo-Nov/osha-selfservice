            ...
            <div class="">
                ...
                <div class="col-12 p-lg-5 p-sm-3 ">
                    ...
                    <div class="col-12 p-0 pb-3 transactions-actions d-none animated mt-5">
                      <h5><strong class="  pb-3">Kindly follow the following instructions to pay for your market rent.</strong></h5>
  ...
  <div class="container">
    <div class="row p-5 ">
      <div class="service-form-container  d-flex flex-column-md animated col-12 p-0">
        <div class="col-lg-7 service-form-img-container" id="market-rent-img">
          <div class="col-lg-8 col-md-12 position-relative p-5">
            <h2 class="mb-4   text-white">RevenueSure market rent</h2>
        ...
        <div class="col-lg-5 p-5 position-relative transactions-form-container d-flex">
          ...
          <form class="transaction-form">
            <div class="form-group col-sm-12 col-md-12 p-0">
              <label for="market" class=" ">Markets</label>
              <select class="form-control select2" id="estate" name="estate">
                <option>-- Select the market --</option>
                @foreach($markets as $market)
                	<option value="{{$market->EstateID}}">{{$market->EstateDescription}}</option>
                @endforeach
              </select>
            ...
            <div class="form-group col-sm-12 col-md-12 p-0">
              <label for="house_type" class=" ">Stall types</label>
              <select class="form-control select2" id="house_type" name="houseTypeID">
                <option >-- Select the stall type --</option>
                <option>Select a stall type</option>
              </select>
            </div>
            <div class="col-sm-2 float-right" id="loader3" >
			  ...
			  <div class="form-group col-sm-12 col-md-12 p-0">
              <label for="house_number" class=" ">Stall numbers</label>
              <select class="form-control select2" id="house_number" name="HouseNumber">
                <option >-- Select stall number --</option>
                <option>Select a stall number</option>
              </select>
            </div>
            ...
            <div class="form-group col-sm-12 col-md-12 p-0 my-3 d-none">
              ...
              <div class="col-12 p-0 pay-container">
                ...
                <div class="col-md-10 col-lg-11 py-4">
                  ...
                  <p class="font-10px m-0">Enter the number you wish to pay with and a payment request will be sent automatically to it.</p>
                </div>
              ...
              <div class="form-group col-sm-12 col-md-12 p-0 my-2">
                <label for="mpesa-phone" class=" ">Phone number</label>
            ...
            <div class="col-12 p-0 text-uppercase mt-5">
              <button type="button" id="btn-confirm" class="btn btn-primary text-white font-14 w-100  center mx-0"><span class="btn-text text-uppercase font-12">CHECK RENT STATUS</span> <i data-feather="arrow-right" class="ml-2 float-right pull-right"></i></button>
            </div>
          </form>
			</div>
            ...
            <p class="mb-5 pb-2  ">
				<span class="back-toform" title="back to transactions form"><i data-feather="arrow-left"  class="mr-3 float-left"></i></span><strong>Confirm your transaction details</strong>
					 ...
					 <div class="transactions-details-container  ">
					 	<p><strong class=" ">Stall details</strong></p>
           ...
           <div class="transactions-details-container  ">
            ...
            <div class=" text-right amount-container">
             ...
             <p id="bill_errors" class="alert alert-danger d-none"></p>
             ...
             <div class="form-group col-sm-12 col-md-12 p-0">
              ...
              <input type="text" class="form-control" id="amount" placeholder="Enter amount to pay" name="amount" value="{{old('amount')}}">
                  ...
                  <a id="pay-mpesa" class="btn btn-primary text-white font-14 w-100  center mx-0 ">
                <div class="btn-txt animated">
             ...
             <div class="col-sm-6 pr-0">
               <a id="pay-bank" class="btn btn-secondary text-white font-14 w-100 center mx-0 ">
                <div class="btn-txt animated">
              ...
              <input type="hidden" id="UHN"  name="UHN" value="{{old('amount')}}">
                  ...
                  $.ajax({
                     ...
                     success:function(data)
                     {
                      // console.log(data.response_data[0]['HOUSETYPE']);
                       if(data == "")
                        {
                          document.getElementById('errors').innerHTML = "We're having trouble retrieving stall types for that market. Please try again later.";
    ...
    $("#btn-confirm").click(function(e){
      ...
      $.ajax({
        ...
        success:function(data){
          ...
          if(data == "")
            {
              document.getElementById('errors').innerHTML = "We're having trouble retrieving stall numbers for that stall type. Please try again later.";
            $('#errors').removeClass('d-none');
            return;
            }
            ...
            document.getElementById("rent").innerHTML = data.response_data.ActualRent;
...
<script type="text/javascript">
  $("#amount").on("change paste keyup", function() {
    ...
    document.getElementById("pay_text").innerHTML = "pay KES " +amount;
});
</script>
...
<script type="text/javascript">
    $("#btn-pay").click(function(e){
      ...
      if(amount > 150000)
      {
        ...
        document.getElementById('pay_errors').innerHTML('Amount is above M-PESA limit');
        return;
      }
      if (amount <= 0) {
        $('#pay_errors').removeClass('d-none');
      ...
      $.ajax({
        ...
        url: "<?php echo url('generate-market-bill')?>" ,
        type: "POST",
        headers:{'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
        ...
        success:function(data){
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    if(data.status_code == 200)
                    {
                      $('#btn-pay').text('Awaiting client payment..');
...
<script type="text/javascript">
  $('#pay-mpesa').click(function(){
    ...
    if(amount > 70000)
      {
        $('#pay_errors').removeClass('d-none');
        document.getElementById('pay_errors').innerHTML= 'Amount is above M-PESA limit. Kindly pay through the bank.';
        return;
      }
      if (amount <= 0) {
        $('#pay_errors').removeClass('d-none');
