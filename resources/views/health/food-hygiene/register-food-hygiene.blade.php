    ...
    <div class="container">
      <div class="row p-5 ">
        <div class="service-form-container  flex-column-md animated col-12 p-0">
          <div class="col-lg-12 service-form-img-container p-0" id="health-img" >
          ...
          <div class="col-lg-12 p-5 position-relative transactions-form-container d-flex p-sm-4">
               <div class="col-12  the-transaction-form animated">
