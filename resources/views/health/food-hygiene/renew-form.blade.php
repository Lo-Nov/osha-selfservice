      ...
      <div class="service-form-container  d-flex flex-column-md animated col-12 p-0">
        ...
        <div class="col-lg-5 p-5 position-relative transactions-form-container d-flex">
         ...
         <div class="">
          ...
          <form class="transaction-form" action="{{ route('rnw-food-hygiene') }}" method="post">
            @if ($errors->any())
        ...
        @endif
            ...
            <div class="col-12 px-0 text-uppercase mt-5 pt-5">
              <button type="submit" class="btn btn-primary text-white font-14 w-100 p-4 center mx-0 btn-confirm-renew-food-hygiene"><span class="btn-text text-uppercase font-12">Renew </span> <i data-feather="arrow-right" class="ml-2 float-right pull-right"></i></button>
            </div>
          </form>
      </div>
...
<script type="text/javascript">
    $('.btn-confirm-renew-food-hygiene').click(function(){
