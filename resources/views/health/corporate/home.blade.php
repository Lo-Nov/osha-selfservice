      ...
      <div class="service-form-container  flex-column-md animated col-12 p-0">
        <div class="col-12 service-form-img-container" id="health-img">
            <div class="col-lg-8 col-md-12 position-relative p-5">
                <h2 class="mb-4   text-white">RevenueSure Corporate Dashboard</h2>
        ...
        @endif
            ...
            <div class="row d-none">
                <div class="col-md-3">
                    <form action="{{ route('get-corporate-bill') }}" method="post">
                        @csrf
                        <input type="hidden" name="corporateId" id="corporateId" value="{{ Session::get('corporateId') }}">
          ...
          <div class="responsive-table">
            <table id="example" class="table table-condensed table-responsive responsive-table table-striped">
                <thead class="">
                    <tr>
                        <th>$</th>
                        <th>Name</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="" href="{{ route('get-corporate-cert',$item->idNo) }}" target="_blank" ><i class="fa fa-print" aria-hidden="true"></i> </a> &nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
                        ...
                        @endif
                        <td>
                            <a class="" href="{{ route('suspend-individual',$item->idNo) }}"><i class="fa fa-ban" aria-hidden="true"></i> </a>
                        </td>
                    </tr>
                    @endforeach()
                </tbody>
