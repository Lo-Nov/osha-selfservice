      ...
      <div class="service-form-container  d-flex flex-column-md animated col-12 p-0">
        <div class="col-lg-7 service-form-img-container" id="health-img">
          <div class="col-lg-8 col-md-12 position-relative p-5">
            <h2 class="mb-4   text-white">RevenuSure Health Department</h2>
        ...
        <div class="col-lg-5 p-5 position-relative transactions-form-container d-flex">
         ...
         <div class="">
          ...
          <form class="transaction-form" action="{{ route('print-food-hygiene-cert') }}" method="post" target="_blank">
            @if ($errors->any())
        ...
        @endif
            ...
            <div class="form-group col-sm-12 col-md-12 p-0 mt-2 mb-5">
                <label for="mpesa-phone" class=" ">Business Or Corporate ID</label>
                <input type="text" class="form-control" id="businessID" placeholder="Enter your Business ID number" name="businessID" value="{{old('businessID')}}">
              </div>
            ...
            <div class="col-12 px-0 text-uppercase mt-5 pt-5">
              <button type="submit" class="btn btn-primary text-white font-14 w-100 p-4 center mx-0 btn-confirm-renew-food-handler"><span class="btn-text text-uppercase font-12"> <i class="fa fa-download"></i> Get License</span> <i data-feather="arrow-right" class="ml-2 float-right pull-right"></i></button>
            </div>
          </form>
      </div>
...
<script type="text/javascript">
    $('.btn-confirm-renew-food-handler').click(function(){
