...
<div class="createfood-loader-container d-none animated">
    ...
    <div class="container">
      <div class="row p-5 ">
        <div class="service-form-container  flex-column-md animated col-12 p-0">
          <div class="col-12 service-form-img-container" id="health-img" style="height: 169px;">
            <div class="col-lg-8 col-md-12 position-relative p-5">
              <h2 class="mb-4 text-white">Get all Corporate printables in one place </h2>
        ...
        @endif
            <div class="col-md-6">
                <h3>Print Corporate Cert</h3>
                <i>Thanks for applying for food handler</i>

                <i>Your food handler certificate is ready, please download</i>



                <form action="{{ route('print-corp-food-handler-cert') }}" target="_blank" method="post" class="transaction-form p-0 w-100 row">
                    @csrf
                  <div class="form-group col-md-12 col-lg-4 mt-2">
                      <input type="hidden" class="form-control " id="corporateId" placeholder="eg Enter your ID Number" value="{{ Session::get('corporateId') }}" name="corporateId" >
                    </div>

                    <div class="col-sm-12 pt-3">
                        <button type="submit" class="btn btn-warning text-white font-12 border-0 text-capitalize"><i class="fa fa-download"></i>  Download</button>
            ...
            <div class="col-md-6">
                ...
                <i>Use  <strong> {{ $pay_id }} </strong>  to print your receipt </i>
            </div>
