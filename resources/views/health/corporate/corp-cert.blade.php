      ...
      <div class="service-form-container  d-flex flex-column-md animated col-12 p-0">
        <div class="col-md-5 service-form-img-container" id="health-img">
         ...
         <ul class="ml-5 pl-2">
             ...
             <li><a href="#">{{ Session::get('corporateId') }}</a><li>
        ...
        <div class="row food-application animated">
           ...
           <form class="transaction-form p-0 w-100 row" action="{{ route('print-corporate-cert') }}" method="post" target="_blank">

               @csrf


             <div class="form-group col-md-12 col-lg-4 mt-2">
                 <label for="lname" class="text-capitalize">Business / Corporate ID <strong class="text-danger">*</strong></label>
                 <input type="text" class="form-control " id="corporateId" value="{{ Session::get('corporateId') }}" name="corporateId" readonly>
               </div>
