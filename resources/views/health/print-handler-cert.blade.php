      ...
      @endif
          <form class="transaction-form" method="post" action="{{ route('print-foodhandler-cert') }}">
            ...
            <div class="col-12 px-0 text-uppercase mt-5 pt-5">
              <button id="btn-otp" type="submit" class="btn btn-primary text-white font-14 w-100 p-4 center mx-0"><span class="btn-text text-uppercase font-12"><i class="fa fa-print"></i> Print Certificate</span> <i data-feather="arrow-right" class="ml-2 float-right pull-right"></i></button>
            </div>
          </form>
      </div>
        ...
        success:function(data){
          $('#loader3').addClass('d-none');
            ...
            if(data == "success"){
              ...
              //alert(id);
              setTimeout(function(){
                window.location = '<?php echo url('get-certificates') ?>/'+id;
            }, 3000);
