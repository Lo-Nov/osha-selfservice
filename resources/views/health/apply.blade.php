      ...
      <div class="service-form-container  d-flex flex-column-md animated col-12 p-0">
        ...
        <div class="col-lg-5 p-5 position-relative transactions-form-container d-flex">
         ...
         <div class="">
          ...
          <form class="transaction-form" action="{{route('health-verify')}}">
            <div id="errors" class="alert alert-danger d-none"></div>
            <div class="form-group col-sm-12 col-md-12 p-0 mt-2 mb-5">
                <label for="mpesa-phone" class=" ">ID Number</label>
                <input type="text" class="form-control" id="plot" placeholder="Enter your national ID number" name="id_number" value="{{old('id_number')}}" required>
              </div>
            ...
            <div class="col-12 px-0 text-uppercase mt-5 pt-5">
              <button type="submit" class="btn btn-primary text-white font-14 w-100 p-4 center mx-0"><span class="btn-text text-uppercase font-12">Check </span> <i data-feather="arrow-right" class="ml-2 float-right pull-right"></i></button>
            </div>
          </form>
      </div>
...
$('#btn-otp').click(function(e){
  ...
  e.preventDefault();
    ...
    var national_id = $('input[name=id_number]').val();
        ...
        success:function(data){
          ...
          $('#loader3').addClass('d-none');
            ...
            if(data == "success"){
              ...
              window.location = "view-food-handlers-certificate/" +id;
