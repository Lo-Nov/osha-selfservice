         ...
         <div class="">
          ...
          <form class="transaction-form">
            ...
            <div class="form-group col-sm-12 col-md-12 p-0 mt-2 mb-5">
                ...
                <input type="text" class="form-control" id="plot" placeholder="Enter your national ID number" name="id_number" value="{{old('id_number')}}">
              </div>
            ...
            <div class="col-12 px-0 text-uppercase mt-5 pt-5">
              <button id="btn-otp" class="btn btn-primary text-white font-14 w-100 p-4 center mx-0"><span class="btn-text text-uppercase font-12">Check credentials</span> <i data-feather="arrow-right" class="ml-2 float-right pull-right"></i></button>
            </div>
          </form>
      </div>
