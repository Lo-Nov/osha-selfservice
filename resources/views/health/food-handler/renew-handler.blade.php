      ...
      <div class="service-form-container  d-flex flex-column-md animated col-12 p-0">
        ...
        @endif
            ...
            <div class="form-group col-sm-12 col-md-12 p-0 mt-2 mb-5">
                ...
                <input type="text" class="form-control" id="idNo" placeholder="Enter your ID number" name="idNo" value="{{old('idNo')}}">
              </div>
            ...
            <div class="col-12 px-0 text-uppercase mt-5 pt-5">
              <button type="submit" class="btn btn-primary text-white font-14 w-100 p-4 center mx-0 btn-confirm-renew-food-handler"><span class="btn-text text-uppercase font-12">Renew Food Handler</span> <i data-feather="arrow-right" class="ml-2 float-right pull-right"></i></button>
            </div>
          </form>
      </div>
