        ...
        <div class="service-form-container  flex-column-md animated col-12 p-0">
          <div class="col-12 service-form-img-container" id="health-img" style="height: 169px;">
            <div class="col-lg-8 col-md-12 position-relative p-5">
              ...
              <h2 class="mb-4 text-white">Get Food Handler Bill details </h2>
...
<!--					  pay via mpesa now-->
                    ...
                    <div class="payment-actions">
                      ...
                      <input type="hidden" class="form-control col flex-grow-1 border-0" id="idNo" value="{{ Session::get('idNo') }}" name="idNo">
...
<script type="text/javascript" src="{{asset('js/jquery.min.js')}}"></script>
    ...
    <script type="text/javascript">
        $(".btn-print-bill").click(function(e){
          ...
          //alert(idNo);
          window.location = '<?php echo url('print-food-handler-bill') ?>/'+idNo;
