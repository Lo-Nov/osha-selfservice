...
<head>
<meta charset="utf-8">
<title class="">Land rates bill</title>
      ...
      <section class="container p-0 m-0">
        <div class="row">
          <div class="col-12">
                ...
                <h2 class="mt-2"><strong>LAND RATES BILL</strong></h2>
                <p>customer copy</p>
              </div>
				</div>
		   ...
		   <div class="px-5 mx-5">
            ...
            <tbody>
              ...
              <tr class=" ">
                ...
                <td>{{$bill->brief_description}} <br> Plot number:	 {{Session::get('plot_number')}}</td>
        ...
        <div class="row">
          <div class="col-12">
				<div class="row px-5 greybg">
			  		 <div class="col-6 pl-5">
					<div class="header-title text-uppercase p-3 pt-3 mx-5 col-8 bg-primary text-white">
                <h2 class=""><strong>LAND RATES BILL</strong></h2>
                <p>file copy</p>
              </div>
				</div>
