            ...
            <div class="">
                ...
                <div class="col-12 p-lg-5 p-sm-3 ">
                    ...
                    <div class="col-12 p-0 pb-3 transactions-actions animated mt-5">
                      <h5><strong class="  pb-3">Kindly follow the following instructions to pay for your daily parking.</strong></h5>
                      <p class="font-14 m-0">Go to the M-PESA menu on your SIM Toolkit</p>          
                       ...
                       <p class="font-14 m-0">Enter <strong id="bill_pay">367776</strong>  as the account no.</p>
    ...
    <div class="row p-5 ">
         ...
         <div class="">
          ...
          <form class="transaction-form">
            ...
            <div class="form-group col-sm-12 col-md-12 p-0">
              <label for="zone" class=" ">Parking zones</label>
              <select class="form-control" id="zone" name="zone_code" required>
            ...
            <div class="form-group col-sm-12 col-md-12 p-0">
              <label for="car_type" class=" ">Vehicle types</label>
              <select class="form-control" id="car_type" name="vehicle_category_code" required>
                <option >-- select vehicle type --</option>
                @foreach($vehicle_categories as $vehicle_category)
                @unless($vehicle_category->is_daily == false)
            ...
            <div class="form-group col-sm-12 col-md-12 p-0 my-3">
              ...
              <div class="col-12 p-0 pay-container">
                ...
                <div class="col-md-10 col-lg-11 py-4">
                  <p class="m-0 font-12  "><strong> M-PESA</strong></p>
            ...
            <div class="col-12 p-4 center danger-light-bg lighter-txt position-relative d-none" id="price">
            <span class="close-price-container position-absolute"> <i data-feather="x"></i></span>
              ...
              <p class="text-uppercase m-0 font-12" id="pay-price"></p>
            </div>
            ...
            <div class="col-12 p-0 text-uppercase mt-5">
              <button class="btn btn-primary text-white font-14 w-100 p-4 center mx-0 " id="btn-confirm"><span class="btn-text text-uppercase font-12">CONFIRM PARKING DETAILS</span> <i data-feather="arrow-right" class="ml-2 float-right pull-right"></i></button>
            </div>
          </form>
      </div>
      ...
      <div class="col-12 d-none p-0 animated details-confirm">
        ...
        <span class="back-toform" title="back to transactions form"><i data-feather="arrow-left"  class="mr-3 float-left"></i></span><strong>Confirm your transaction details</strong>
           ...
           <hr class="mt-1 p-0">
           <p><strong class=" ">Parking payment details</strong></p>
           ...
           <div class="transactions-details-container  ">
            ...
            <div class=" text-right amount-container">
                 <p><span class="text-uppercase text-left">Total cost: KES</span> <strong  id="charges_cost"> </strong></p>
                 <p><span class="text-uppercase text-left">Amount Paid: KES</span> <strong  id="charges_paid"> </strong></p>
                 <p><span class="text-uppercase text-left">Amount due: KES</span> <strong  id="charges"> </strong></p>
             </div>
             <hr>
             ...
             <form >
              ...
              <input type="text" class="form-control" id="phone-number" name="phone" value="{{Session::get('resource')['phone_number']}}">
              @else
              <input type="text" class="form-control" id="phone-number" name="phone" placeholder="Enter your phone number" value="{{old('phone')}}">
              @endif
...
<script type="text/javascript">
  $("#number-plate").on("change paste keyup", function() {
      ...
      $.ajax({
        ...
        data: {vehicle_category_code:vehicle_category_code, zone_code:zone_code, registration_number:registration_number},

        success:function(data){
          if(data.status_code ==200)
          {
          document.getElementById('pay-price').innerHTML = data.response_data.balance;
...
<script type="text/javascript">
    $("#btn-confirm").click(function(e){
      ...
      if(vehicle_category_code == "" || zone_code == "" || registration_number == "" || phone_number == "")
      {
      ...
      $.ajax({
        ...
        type: "POST",
        headers:{'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
        data: {vehicle_category_code:vehicle_category_code, zone_code:zone_code, registration_number:registration_number, phone_number:phone_number},
        ...
        success:function(data){
          ...
          if(data == "")
          {
            document.getElementById('errors').innerHTML = 'We are having trouble retrieving your parking charges. Please try again later.';
          ...
          if(data.status_code == 200){
            ...
            document.getElementById("charges_cost").innerHTML = data.response_data.total_cost;
            document.getElementById("charges_paid").innerHTML = data.response_data.total_paid;
            document.getElementById("charges").innerHTML = data.response_data.balance;
    ...
    $("#btn-pay").click(function(e){
      ...
      $.ajax({
        ...
        success:function(res){
            ...
            if(res == "")
            {
              document.getElementById('errors').innerHTML = 'We are having trouble initiating payment. Please try again later.';
                $('#errors').removeClass('d-none');
                $('.btn-txt').removeClass('d-none');
                $('.lds-ellipsis').addClass('d-none'); 
                return;
      ...
      if(recheck_count==12)
                ...
                else
                {
                    ...
                    success: function(data)
                    {
                      if(data == "")
                      {
                        document.getElementById('errors').innerHTML = 'We are having trouble retrieving your receipt. Please try again later.';
                          $('#errors').removeClass('d-none');
                          $('.btn-txt').removeClass('d-none');
                          $('.lds-ellipsis').addClass('d-none'); 
                          return;
