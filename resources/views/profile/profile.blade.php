            ...
            $.ajax({
                ...
                success:function(data){
                     ...
                     if(status != 200){
                         ...
                         $('#msg').html('You have changed your password successfully, please logout or remember to use your new password next time').fadeIn('slow');
                         //$('#msg').html("data insert successfully").fadeIn('slow') //also show a success message
    ...
    <script type="text/javascript">
        $('#updateProfile').click(function(e){
            ...
            $.ajax({
                ...
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                data:{user_id:user_id, first_name:first_name, middle_name:middle_name,last_name:last_name, email:email, national_id:national_id},
                ...
                success:function(data){
                     ...
                     if(status != 200){
                         $('#update_message').removeClass('d-none');
                         $('#update_message').addClass('alert-danger');
                         $('#update_message').text(data.message);
                         
                         $('#update_message').delay(5000).fadeOut('slow');
                     }else{
                        $('#update_message').removeClass('d-none');
                        $('#update_message').addClass('alert-success');
                         $('#update_message').text(data.message).fadeIn('slow');
