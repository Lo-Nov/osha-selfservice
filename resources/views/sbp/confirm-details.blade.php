            ...
            <div class="">
                <div class="show-amount-loader">
                    <center class="p-5 text-white">
                      ...
                      <!-- <h2 class="mb-5 pb-5 text-capitalize text-white"><sup class="font-14 text-uppercase">Kes</sup>{{number_format($total)}}</h2> -->
                    </center>
                </div>
                <div class="col-12 p-lg-5 p-sm-3 ">
                    ...
                    <div class="col-12 p-0 pb-3 transactions-actions d-none animated mt-5">
                      <h5><strong class="  pb-3">Kindly follow the following instructions to pay for the registration.</strong></h5>
      ...
      <div class="service-form-container  flex-column-md animated col-12 p-0">
        <div class="col-12 service-form-img-container" id="biz-img" style="height: 169px;">
          <div class="col-lg-8 col-md-12 position-relative p-5">
            <h2 class="mb-4   text-white">RevenueSure business registration</h2>
        ...
        <div class="col-12 p-5 position-relative transactions-form-container d-flex">
            ...
            <p class="mb-5 pb-2  ">
             ...
             <strong id="business_id">{{$business_id}}</strong>
             <hr>
						 <p class="m-0"><span>Business category</span></p>
						 <strong id="business_category">{{$businessActivity}}</strong>
						 <hr>
						 
						<p class="m-0"> <span>KRA PIN</span></p>
						 <strong class="text-uppercase" id="pin_number">{{$PINNumber}}</strong>
						 <hr>
             ...
             @if($total > 150000)
						 <p>The amount payable is greater than the MPESA limit 150,000. Kindly print the bill and pay at the bank.</p>
						<a target="new" type="button" class="btn btn-primary text-white font-14 w-100 p-4 center mx-0" href="{{route('print-sbp-bill', ['id' => $bill_number])}}">
              ...
              @else
                      ...
                      <input type="hidden" class="form-control" id="business_id" name="business_id" value="{{$business_id}}">
				            </div>
            ...
            <div class="p-5 text-uppercase mt-5 col-sm-6">
              <a type="button" target="new" href="{{route('print-sbp-bill', ['id' => $bill_number])}}" class="btn btn-secondary text-white font-14 w-100  center mx-0 ">
                  <div class="btn-txt animated">
            ...
            <p class="alert alert-success">You can now proceed to print your receipt or permit</p>      
               <div class=" p-5 text-uppercase mt-5 col-sm-6">
                      <a type="button" target="new" href="{{route('view-sbp-permit', ['id' => $bill_number, 'business_id' => $business_id])}}" id="pay-mpesa" class="btn btn-primary text-white font-14 w-100 center mx-0">
                        <div class="btn-txt animated" id="btn-mpesa">
            ...
            <div class="p-5 text-uppercase mt-5 col-sm-6">
              <a type="button" target="new" href="{{route('view-receipt', ['id' => $bill_number])}}" class="btn btn-secondary text-white font-14 w-100 center mx-0 ">
                  <div class="btn-txt animated">
