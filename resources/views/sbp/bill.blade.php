...
<head>
<meta charset="utf-8">
<title class="">Business permit bill</title>
      ...
      <section class="container p-0 m-0">
        <div class="row">
          <div class="col-12">
                ...
                <h2 class="mt-2"><strong>Business permit bill</strong></h2>
                <p>customer copy</p>
              </div>
				</div>
...
<!--	  the main section-->
	   <section class="container px-5  m-0  ">
		   ...
		   <h6 class="  serial-init font-22 mb-0">{{$bill->Customer}}</h6>
		   <p class="m-0 p-0"><strong class="weight-600">{{$bill->Description}}</strong></p>
		   </div>
		   ...
		   <div class="row px-5 greybg payment_options">
            ...
            <tbody class="border-bottom">
              <tr class="  pl-0">
                <td class="py-2 pl-0">
					<table class=" ">
						<tbody><tr><td class="py-0 pl-0"><ol ><li type="1">
									M-PESA paybill no:
									<br>
									M-PESA account no.
									</li>
								...
								<td class="py-0"><strong>367776 <br> {{$bill->PaymentCode}}</strong></td></tr>
						<!-- <tr><td class="py-0 pl-0">M-PESA account no.</td><td class="text-uppercase py-0"><strong>{{$bill->BillNo}}</strong></td></tr> -->
        ...
        <div class="row">
          <div class="col-12">
				<div class="row px-5 greybg">
			  		 <div class="col-6 pl-5">
					<div class="header-title text-uppercase p-3 pt-3 mx-5 col-8 bg-primary text-white">
                <h2 class=""><strong>Business permit bill</strong></h2>
                <p>file copy</p>
              </div>
				</div>
