...
.content-container {
    background:url("permit/img/nrbbg.jpg");
  ...
  <page size="B4" class="p-2 container w-100 h-100">
    <section class="content-container h-100 w-100 position-relative p-2">
      <header>
        <section class="container p-0 m-0">
          <div class="row"> 
            ...
            <!--				logo container-->
            <div class="col-12">
              <div class=""> <img  src="{{asset('permit/img/biz-header.png')}}" class="w-100"> </div>
            </div>
            ...
            <div class="col-12 d-flex mt-2">
              ...
              <div class="col-6">
                <div>
                  <p class="text-left">Date of Issue :<span class="libre-bold">{{$permit->date_issued}}</span> </p>
                </div>
              </div>
              <div class="col-6">
                <div>
                  <p class="float-right dropright text-right"> <span class="other-num text-right col-auto right p-0 serial-init">Trade License For The Year: <strong class="serial">{{$permit->calendar_year}}</strong></span></p>
                <p class="float-right dropright text-right"></div>
              </div>
            </div>
          </div>
        </section>
      ...
      <section class="container p-3 m-0">
        <div class="row">
          <div class="col-12 ">
            <p class="text-left"><span class="libre-bold">This business permit is granted to:</span></P>
          </div>
          <div class="col-8">
              ...
              <tbody>
                ...
                <tr>
                  <td><p class="p-0 m-0">Applicant/Business/Commercial Name</p>
                    <p class="text-uppercase libre-bold m-0 p-0 title-font">{{$permit->business_name}}</p></td>
                </tr>
                
                
                <!--				the businness ID-->
                <tr>
                  <td class="  serial-init ">Pin Number: <span class="serial">{{$permit->pin_no}}</span></td>
                </tr>
              </tbody>
            </table>
          </div>
          <div class="col-4 mb-1">
            <div class="locence-no max-height d-flex h-100 justify-content-center align-items-center align-content-center p-2 flex-column">
              ...
              <p> <span class="serial-init font-22"> <span class="serial">{{$permit->business_id}}</span></span></p>
            </div>
          </div>
          <div class="col-8 mt-4">
              ...
              <tbody>
                <tr>
                  <td colspan="2"><p class="text-uppercase p-0 m-0">To engage in the activity/Business/Profession or Occupation of</p>
                    <p class="text-uppercase libre-bold m-0 p-0 serial m-0">{{$permit->business_activity_description}}</p>
					</td>
                </tr>
                
                <tr>
                  <td class="">{{$permit->business_activity_name}}</td>
                </tr>
            ...
            <div class="activity-code-bg max-height d-flex h-100 justify-content-center align-items-center align-content-center p-2 flex-column">
              ...
              <p> <span class="serial-init font-22"> <span class="serial">{{$permit->activity_code}}</span></span></p>
            </div>
          </div>
            ...
            <table class="table table-bordered table-striped">
              <tbody>
                <tr>
                  ...
                  <td class="title-font">Ksh. {{number_format($permit->amount_paid)}}</td>					
                </tr>
                <tr>
                  <td  class="other-num serial-init">{{$permit->amount_paid}}</td>
              ...
              <tbody>
                <tr class="locence-no">
                 <div class="">
                         ...
                         <td class="locence-no" colspan="2">{{$permit->valid_from}} <span class="libre-bold locence-no p-1"> </span></td>
                ...
                <tr>
                  <td colspan="2">P.O. Box : <span class="libre-bold">{{$permit->contact_person_po_box}}</span></td>
                  <td>Plot No. : <span class="libre-bold title-font">{{$permit->plot_no}}</span></td>
                </tr>
                <tr>
                  <td colspan="3">Road Street : <span class="title-font">{{$permit->physical_address}}</span></td>
                </tr>
				  <tr>
                  <td>Building : <span class="libre-bold">47-10207 Nairobi</span></td>
                  <td>Floor : <span class="libre-bold">749/9404</span></td>
				  <td>Dorr/Stall No. : <span class="libre-bold">749/9404</span></td>
                </tr>
                <tr>
                  <td colspan="3"> This Permit Is for : <span class="libre-bold">{{$permit->business_activity_description}}</span></td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div class="col-8 mt-4">
            ...
            <ol class="libre-it d-none">
			  	<li>from monday to friday during trhe hours of <b>5:00 PM to 11:00 PM</b></li>
				<li>during <b> weekends and public holidays</b> during the hours of <b>2:00 PM to 11:00 PM</b></li>
				<li>on any day of week at any hour to persons taking meals in the resturant, for consumption with such meals.</li>
			  </ol>
          </div>
			  
		 <div class="col-4 d-flex justify-content-center align-items-center mt-2">
			<div>
			 	<img src="{{asset('permit/img/aapproved.png')}}" class="the-seal">
			 </div>
	  		</div>
        </div>
      </section>
      <div class="container position-absolute footer-container">
        <div class="row">
          <div class="col-8">
            <div class="row">
              <div class="col-12"> <img class="mb-2 float-left theqr" src="{{asset('permit/img/5d37325ea1ff6.png')}}"  > </div>
            </div>
            <hr class="mt-0 mb-1 mb-5">
            <p class="text-left">Granting this permit does not exempt the business identified above from complying with the current regulation on health and safety as established by the Government of Kenya.</p>
          </div>
        </div>
      </div>
      <img src="{{asset('permit/img/NBK logo.png')}}" class="nbk"> 
	  </section>
  </page>
