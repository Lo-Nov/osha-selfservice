        ...
        <section class="container p-0 m-0">
          <div class="row"> 
            ...
            <div class="col-12 d-flex mt-2">
              ...
              <div class="col-6">
                <div>
                  <p class="text-left">Date of Issue :<span class="libre-bold">{{$permit->dateIssued}}</span> </p>
                </div>
              </div>
              <div class="col-6">
                <!-- <div>
                  <p class="float-right dropright text-right"> <span class="other-num text-right col-auto right p-0 serial-init">Trade License For The Year: <strong class="serial">{{$permit->expiryDate}}</strong></span></p>
        ...
        <div class="row">
          ...
          <div class="col-8">
            <table class="table table-bordered mb-0">
              <tbody>
                ...
                <!--				the businness ID-->
                <tr>
                  <td class="  serial-init ">Pin Number: <span class="serial">{{$permit->pinNmber}}</span></td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div class="col-8 mt-4">
              ...
              <tbody>
                <tr>
                  <td colspan="2"><p class="text-uppercase p-0 m-0">To engage in the activity/Business/Profession or Occupation of</p>
                    <p class="text-uppercase libre-bold m-0 p-0 serial m-0">{{$permit->BusinessActivityName}}</p>
					</td>
                </tr>
                
                <tr>
                  <td class="">{{$permit->BusinessActivityDescription}}</td>
                </tr>
            ...
            <div class="activity-code-bg max-height d-flex h-100 justify-content-center align-items-center align-content-center p-2 flex-column">
              ...
              <p> <span class="serial-init font-22">LID <span class="serial">{{$permit->ActivityCode}}</span></span></p>
            </div>
          </div>
            ...
            <table class="table table-bordered table-striped">
              <tbody>
                ...
                <tr>
                  <td  class="other-num serial-init">*** {{$amount_in_words}} shillings only***</td>
					<td class="text-uppercase">Payment Plan: <span class="libre-bold">{{$permit->paymentPlan}} months</span></td>
                </tr>
          ...
          <div class="col-12 mt-4">
            <table class="table table-bordered table-striped">
              <tbody>
                ...
                <tr>
                  <td colspan="2">P.O. Box : <span class="libre-bold">{{$permit->BusinessBoxNo}}</span></td>
                  <td>Plot No. : <span class="libre-bold title-font">{{$permit->BusinessPlotNo}}</span></td>
                </tr>
                <tr>
                  <td colspan="3">Road Street : <span class="title-font">{{$permit->BusinessPhysicalAddress}}</span></td>
                </tr>
				  <tr>
                  <td>Building : <span class="libre-bold">{{$permit->BuildingName}}</span></td>
                  <td>Floor : <span class="libre-bold">{{$permit->BuildingFloorNo}}</span></td>
				  <td>Door/Stall No. : <span class="libre-bold">{{$permit->BusinessHouseNo}}</span></td>
                </tr>
                <tr>
                  <td colspan="3"> This Permit Is for : <span class="libre-bold">{{$permit->subActivityCatDesc}}</span></td>
                </tr>
              </tbody>
            </table>
          </div>
		 ...
		 <div class="col-4 d-flex justify-content-center align-items-center mt-2">
			<div>
			 	<img src="{{asset('permit/img/provissional.png')}}" class="the-seal">
			 </div>
	  		</div>
        </div>
      </section>
