...
<section id="service-form-section" class="parallax-section p-0">
  <div class="contaner">
  	...
  	<div class="service-form-container  d-flex flex-column-md animated col-12 p-0">
		   <div class="col-lg-12 p-5 position-relative transactions-form-container d-flex">
		   	<div class="col-12 p-5 m-5 the-transaction-form animated private-policy">
			   <h2>Privacy Policy for Nairobi City County E-payments Mobile Application</h2>
               <hr>
               <p>This Application collects some Personal Data from its Users.</p>
               <h4>Owner and Data Controller</h4>
               <p class="mb-1">Nairobi City Hall, City Hall Way, Nairobi, Kenya</p>
               <p><strong>Email:</strong> <a href="https://mail.google.com/mail/u/0/#inbox?compose=CllgCJfrLDsDhcFVWNRmWvzQCGWsDVgDfDlzmzfJsqcLGNJtCdRWWpSTDKCpNtZXcLqbwdfJPSV" target="new" class="text-info">047ncc@gmail.com</a></p>
              <h4>Types of Data collected</h4>
              <p>Among the types of Personal Data that this Application collects, by itself or through third parties, there are: Camera permission; Approximate location permission (continuous); Phone permission; Storage permission.</p> 
              <p>Complete details on each type of Personal Data collected are provided in the dedicated sections of this privacy policy or by specific explanation texts displayed prior to the Data collection.
                ...
                <p>For specific information about the Personal Data used for each purpose, the User may refer to the section <i>“Detailed information on the processing of Personal Data”</i>.</p>
                <h5>Device permissions for Personal Data access</h5>
                ...
                <p>Please note that the revoking of such permissions might impact the proper functioning of this Application. If User grants any of the permissions listed below, the respective Personal Data may be processed (i.e accessed to, modified or removed) by this Application.</p>
                <p><strong>Approximate location permission (continuous)</strong></p>
                ...
                <ul>
                    ...
                    <li>
                        <strong>Device permissions for Personal Data access (this Application)</strong>
                        ...
                        <p>Personal Data processed: Approximate location permission (continuous); Camera permission; Phone permission; Storage permission.</p>
                    </li>
                </ul>
                ...
                <p>Users may exercise certain rights regarding their Data processed by the Owner.
                    ...
                    <h6>Additional information about Data collection and processing</h6>
                    ...
                    <p><strong>How <i>“Do Not Track”</i> requests are handled</strong></p>
